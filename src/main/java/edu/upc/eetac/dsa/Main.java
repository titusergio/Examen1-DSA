...
public class Main {
    ...
    public static HttpServer startServer() {
        ...
        final ResourceConfig rc = new ResourceConfig().packages("edu.upc.eetac.dsa.services");  //paquet on estan els serveis!!!   veu que hi ha una classe, i si veu notacions de tipus serveis, genera jsson
    ...
    public static void main(String[] args) throws IOException {
        ...
        StaticHttpHandler staticHttpHandler = new StaticHttpHandler("./public/");   //front end
